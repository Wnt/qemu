...
uint16_t _TRACE_S3_VGA_CMD_DSTATE;
uint16_t _TRACE_S3_VGA_CMD_LINE_BRESENHAM_DSTATE;
uint16_t _TRACE_S3_VGA_CMD_LINE_VECTOR_DSTATE;
uint16_t _TRACE_S3_VGA_CMD_RECT_DSTATE;
uint16_t _TRACE_S3_VGA_CMD_BITBLT_DSTATE;
uint16_t _TRACE_S3_VGA_ENABLE_READB_DSTATE;
uint16_t _TRACE_S3_VGA_ENABLE_WRITEB_DSTATE;
uint16_t _TRACE_S3_VGA_DAC_READB_DSTATE;
uint16_t _TRACE_S3_VGA_DAC_WRITEB_DSTATE;
uint16_t _TRACE_S3_VGA_IO_READB_DSTATE;
uint16_t _TRACE_S3_VGA_IO_READW_DSTATE;
uint16_t _TRACE_S3_VGA_IO_WRITEB_DSTATE;
uint16_t _TRACE_S3_VGA_IO_WRITEW_DSTATE;
...
TraceEvent _TRACE_S3_VGA_CMD_EVENT = {
    .id = 0,
    .name = "s3_vga_cmd",
    .sstate = TRACE_S3_VGA_CMD_ENABLED,
    .dstate = &_TRACE_S3_VGA_CMD_DSTATE
};
TraceEvent _TRACE_S3_VGA_CMD_LINE_BRESENHAM_EVENT = {
    .id = 0,
    .name = "s3_vga_cmd_line_bresenham",
    .sstate = TRACE_S3_VGA_CMD_LINE_BRESENHAM_ENABLED,
    .dstate = &_TRACE_S3_VGA_CMD_LINE_BRESENHAM_DSTATE
};
TraceEvent _TRACE_S3_VGA_CMD_LINE_VECTOR_EVENT = {
    .id = 0,
    .name = "s3_vga_cmd_line_vector",
    .sstate = TRACE_S3_VGA_CMD_LINE_VECTOR_ENABLED,
    .dstate = &_TRACE_S3_VGA_CMD_LINE_VECTOR_DSTATE
};
TraceEvent _TRACE_S3_VGA_CMD_RECT_EVENT = {
    .id = 0,
    .name = "s3_vga_cmd_rect",
    .sstate = TRACE_S3_VGA_CMD_RECT_ENABLED,
    .dstate = &_TRACE_S3_VGA_CMD_RECT_DSTATE
};
TraceEvent _TRACE_S3_VGA_CMD_BITBLT_EVENT = {
    .id = 0,
    .name = "s3_vga_cmd_bitblt",
    .sstate = TRACE_S3_VGA_CMD_BITBLT_ENABLED,
    .dstate = &_TRACE_S3_VGA_CMD_BITBLT_DSTATE
};
TraceEvent _TRACE_S3_VGA_ENABLE_READB_EVENT = {
    .id = 0,
    .name = "s3_vga_enable_readb",
    .sstate = TRACE_S3_VGA_ENABLE_READB_ENABLED,
    .dstate = &_TRACE_S3_VGA_ENABLE_READB_DSTATE
};
TraceEvent _TRACE_S3_VGA_ENABLE_WRITEB_EVENT = {
    .id = 0,
    .name = "s3_vga_enable_writeb",
    .sstate = TRACE_S3_VGA_ENABLE_WRITEB_ENABLED,
    .dstate = &_TRACE_S3_VGA_ENABLE_WRITEB_DSTATE
};
TraceEvent _TRACE_S3_VGA_DAC_READB_EVENT = {
    .id = 0,
    .name = "s3_vga_dac_readb",
    .sstate = TRACE_S3_VGA_DAC_READB_ENABLED,
    .dstate = &_TRACE_S3_VGA_DAC_READB_DSTATE
};
TraceEvent _TRACE_S3_VGA_DAC_WRITEB_EVENT = {
    .id = 0,
    .name = "s3_vga_dac_writeb",
    .sstate = TRACE_S3_VGA_DAC_WRITEB_ENABLED,
    .dstate = &_TRACE_S3_VGA_DAC_WRITEB_DSTATE
};
TraceEvent _TRACE_S3_VGA_IO_READB_EVENT = {
    .id = 0,
    .name = "s3_vga_io_readb",
    .sstate = TRACE_S3_VGA_IO_READB_ENABLED,
    .dstate = &_TRACE_S3_VGA_IO_READB_DSTATE
};
TraceEvent _TRACE_S3_VGA_IO_READW_EVENT = {
    .id = 0,
    .name = "s3_vga_io_readw",
    .sstate = TRACE_S3_VGA_IO_READW_ENABLED,
    .dstate = &_TRACE_S3_VGA_IO_READW_DSTATE
};
TraceEvent _TRACE_S3_VGA_IO_WRITEB_EVENT = {
    .id = 0,
    .name = "s3_vga_io_writeb",
    .sstate = TRACE_S3_VGA_IO_WRITEB_ENABLED,
    .dstate = &_TRACE_S3_VGA_IO_WRITEB_DSTATE
};
TraceEvent _TRACE_S3_VGA_IO_WRITEW_EVENT = {
    .id = 0,
    .name = "s3_vga_io_writew",
    .sstate = TRACE_S3_VGA_IO_WRITEW_ENABLED,
    .dstate = &_TRACE_S3_VGA_IO_WRITEW_DSTATE
};
TraceEvent *hw_display_trace_events[] = {
    ...
    &_TRACE_S3_VGA_CMD_EVENT,
    &_TRACE_S3_VGA_CMD_LINE_BRESENHAM_EVENT,
    &_TRACE_S3_VGA_CMD_LINE_VECTOR_EVENT,
    &_TRACE_S3_VGA_CMD_RECT_EVENT,
    &_TRACE_S3_VGA_CMD_BITBLT_EVENT,
    &_TRACE_S3_VGA_ENABLE_READB_EVENT,
    &_TRACE_S3_VGA_ENABLE_WRITEB_EVENT,
    &_TRACE_S3_VGA_DAC_READB_EVENT,
    &_TRACE_S3_VGA_DAC_WRITEB_EVENT,
    &_TRACE_S3_VGA_IO_READB_EVENT,
    &_TRACE_S3_VGA_IO_READW_EVENT,
    &_TRACE_S3_VGA_IO_WRITEB_EVENT,
    &_TRACE_S3_VGA_IO_WRITEW_EVENT,
  NULL,
};
